	...
	<div class="signup-page-content">
		<div class="container">
			<div class="w-50 mx-auto text-center">
				...
				<h1 class="form-title fs-48">Sign in</h1>
				<p class="fs-24">Or <a class="form-link" href="<?php echo base_url('/signup')?>">click here to sign up</a> if you do not have account</p>
				<div class="mw-500 mx-auto">
					<div class="form-wrap">
						...
						<div class="form-row">
							<div class="form-col-100">
								<span class="btn btn-primary w-100">Login</span>
							</div>
						</div>
					</div>
					...
					<span class="btn btn-icon btn-outline w-100">
						...
						<span class="btn-icon__text">Sign with Google</span>
					</span>
